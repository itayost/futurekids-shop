    ...
    return (
      <div className="bg-red-50 min-h-screen flex items-center justify-center p-6">
        <div className="bg-white border-4 border-black rounded-3xl p-12 hard-shadow text-center max-w-lg">
          ...
          <Link
            href="/"
            className="btn-retro inline-flex items-center justify-center gap-2 bg-pink-500 text-white px-8 py-4 rounded-xl font-black text-lg border-2 border-black hover:bg-pink-600"
          >
