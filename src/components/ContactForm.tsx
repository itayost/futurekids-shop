...
export default function ContactForm() {
  return (
    <form
      ...
      method="POST"
      className="bg-white border-4 border-black rounded-3xl p-8 hard-shadow"
    >
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={5}
            className="w-full border-2 border-black rounded-xl p-3 font-medium focus:outline-none focus:ring-2 focus:ring-pink-500 resize-none"
        ...
        <button
          type="submit"
          className="w-full btn-retro bg-pink-500 text-white py-4 rounded-xl font-black text-lg border-2 border-black hover:bg-pink-600 flex items-center justify-center gap-2"
        >
