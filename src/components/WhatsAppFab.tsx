...
// Business WhatsApp line, in the international format wa.me expects.
const WHATSAPP_NUMBER = '972505533449';
const PREFILLED_MESSAGE = 'היי, הגעתי מהאתר של KidCode ויש לי שאלה';
